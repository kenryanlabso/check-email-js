...
const EMAIL_WITH_DOMAIN_REGEX = (name, extension) => new RegExp(`^\\w+([.-]?\\w+)*@${name}\\.${extension}$`); // Regular expression pattern for email validation with domain
 ...
 */
function getResponse(valid, email = null, error = null) {
